					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="lastName" placeholder=""
								class="form-control" name="dept_no" value="${dept_no}" autofocus>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">청구인</label>
						<div class="col-sm-9">
							<input type="text" placeholder="" value = "${member_id}" class="form-control"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" placeholder="" class="form-control"
								name="order_product_cnt">
						</div>
					</div>

					<button type="submit" class="btn btn-primary ">청구</button>
				</form>
				<!-- /form -->
			</div>
		</div>
