...
<body>
	...
	<div id="wrapper">
		...
		<div class="main" align="center">
			<div class="container">
				<form class="form-horizontal" action="memberUpdate.do" role="form" method="post">
					<h4>회원정보수정</h4>
					<div class="form-group">
						<label for="firstName" class="col-sm-3 control-label">아이디</label>
						<div class="col-sm-9">
							<input type="text" id="firstName" placeholder="ID"
								class="form-control" name="member_id" value="${member.member_id}" readonly="readonly" autofocus>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" id="lastName" placeholder="password"
								class="form-control" name="member_pwd" value="${member.member_pwd}" autofocus>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" placeholder="dept" class="form-control"
								name="dept_no" value="${member.dept_no}" readonly="readonly">
						</div>
					</div>
