	...
	<div id="wrapper">
		...
		<div class="main" align="center">
			<div class="container">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="firstName" placeholder="ID"
								...
								value="${member.member_id}" autofocus>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" placeholder="dept" class="form-control"
								name="dept_no" value="${member.dept_no}">
						</div>
					</div>
				...
				<br/>
					<a href="adminMemberDelete.do?member_id=${member.member_id}"><button class="btn btn-primary ">삭제</button></a>
				<!-- /form -->
			</div>
			<!-- ./container -->
		</div>
